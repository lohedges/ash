...
```sh
CONDA_OVERRIDE_CUDA="11.2" conda create ash-lite -c conda-forge ase compilers cudatoolkit=11.2 cudatoolkit-dev=11.2 eigen jax jaxlib=\*=cuda\* mdtraj openmm pytorch-gpu torchani
